...
run_once("nm-applet")
run_once("tlp start")
run_once("modprobe tp_smapi")
run_once("modprobe phc-intel")
delay_run_once("ibus-daemon -d -x -r")
...
-- {{{ Font Setting -----------------------------------------------------------
awesome.font = "WenQuanYi Micro Hei Mono 12"
-- }}} ------------------------------------------------------------------------
...
for i = 1, 9 do
    ...
    globalkeys = awful.util.table.join(globalkeys,
       awful.key({ modkey }, "#" .. i + temp,
        ...
        awful.key({ modkey, "Control", "Shift" }, "#" .. i + temp,
                  function ()
                      if client.focus then
                         if client.focus and tags[client.focus.screen][i] then
                             awful.client.toggletotag(tags[client.focus.screen][i])
                         end
                      end
                  end))
end
